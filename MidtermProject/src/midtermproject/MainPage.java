...
public class MainPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("High Tower Text", 1, 28)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 153));
        jLabel1.setText("Welcome To Procurement Project");

        jButton1.setBackground(new java.awt.Color(153, 153, 0));
        jButton1.setFont(new java.awt.Font("High Tower Text", 0, 18)); // NOI18N
        jButton1.setForeground(new java.awt.Color(0, 0, 102));
        jButton1.setText("Click To Main Menu Page");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       AdminLogin1 f1=new AdminLogin1();
       f1.setVisible(true);
